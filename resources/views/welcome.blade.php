...
@section('content')
    ...
    <section class="mt-16">
        <div class="flex justify-between items-center">
            ...
            <div class="w-full">
                <h1 class="text-3xl sm:text-5xl font-bold leading-relaxed">{{$settings->title_heading}}</h1>
                <p class="w-full sm:w-2/3 min-w-0 text-lg font-medium leading-relaxed mt-8">{{$settings->subtitle_heading}}</p>
                <div class="mt-10">
    ...
    <section class="mt-32">
        <div class="flex-row sm:flex">
            @if($settings->testemonial_1_provider != "")
              <div class="shadow-lg bg-white p-6 w-full">

                  <div class="flex justify-between items-start">
                      <div class="flex">
                          <img src="{{$settings->testemonial_1_img_link}}" alt="user_1" class="w-16">
                          <div class="self-center ml-4">
                              <h1 class="font-medium">{{$settings->testemonial_1_provider}}</h1>
                              <h2 class="text-doc_primary mt-2">{{$settings->testemonial_1_profession}}</h2>
                          </div>
                      </div>
                  ...
                  <p class="leading-relaxed mt-4">
                      “{{$settings->testemonial_1_text}}”
                  </p>

              </div>
            @endif
            @if($settings->testemonial_2_provider != "")
            <div class="shadow-lg bg-white p-6 mt-6 sm:mt-0 sm:ml-6 w-full">

                <div class="flex justify-between items-start">
                    <div class="flex">
                        <img src="{{$settings->testemonial_2_img_link}}" alt="user_2" class="w-16">
                        <div class="self-center ml-4">
                            <h1 class="font-medium">{{$settings->testemonial_2_provider}}</h1>
                            <h2 class="text-doc_primary mt-2">{{$settings->testemonial_2_profession}}</h2>
                        </div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="fill-current text-doc_primary w-12"><path d="M0 4v12h8c0 4.41-3.586 8-8 8v4c6.617 0 12-5.383 12-12V4H0zM20 4v12h8c0 4.41-3.586 8-8 8v4c6.617 0 12-5.383 12-12V4H20z"/></svg>
                </div>
    ...
    <!-- Story -->
    <section class="mt-32">
      @if($settings->about_heading_left != "" && $settings->about_heading_right != "")
        ...
        <div class="flex-row sm:flex sm:justify-between mt-6">
            <div class="p-4 w-full">
                ...
                <div>
                    @if($settings->about_heading_left != "")
                    <div class="flex items-center">
                        ...
                        <h1 class="font-semibold text-lg ml-2">{{$settings->about_heading_left}}</h1>
                    </div>
                    @endif

                    <p class="mt-4 leading-relaxed text-justify">{{$settings->about_text_left}}</p>
                </div>
            </div>
            ...
            <div class="p-4 w-full">
                ...
                <div>
                    @if($settings->about_heading_right != "")
                    <div class="flex items-center">
                        ...
                        <h1 class="font-semibold text-lg ml-2">{{$settings->about_heading_right}}</h1>
                    </div>
                    @endif
                    <p class="mt-4 leading-relaxed text-justify">{{$settings->about_text_right}}</p>
                </div>
            </div>
